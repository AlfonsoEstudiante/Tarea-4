...
@Composable
fun AlumnCard(navController: NavHostController, alumn: Alumnos, color: Color) {
...
fun PreviewCard() {
    AlumnCard(
        ...
        alumn = Alumnos(22180, "Alfonso Madero Benítez", "alfonso.madero@iest.edu.mx", 8, "Licenciatura en Ingeniería en Sistemas y Negocios Digitales (Plan 2020)", true, 8.65, 0, R.drawable.cap),
