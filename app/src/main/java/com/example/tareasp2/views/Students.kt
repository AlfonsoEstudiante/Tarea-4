...
import com.example.tareasp2.viewmodels.AlumnosViewModels
...
fun ListView(navController: NavHostController) {
    ...
    var color = Color(0xFFF9EBCF)
    val GamesViewModel = AlumnosViewModels()
    ...
    Column (
        ...
        Column {
            ...
            Button(
                onClick = {
                    val alumnList = GamesViewModel.getListaAlumnos()
        ...
        LazyColumn {
            items(GamesViewModel.getListaAlumnos()) {
                    alumn ->
